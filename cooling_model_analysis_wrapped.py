"""
Created by Ben Kaiser (UNC-Chapel Hill) 2019-10-04. Spun off by Ben Kaiser (UNC-Chapel Hill) 2025-04-07. I want to be able to flexibly use parts of this in other places in my code, namely running through a list of Teff and logg and just returning masses with errorbars for a ton of white dwarfs (in this case the MORDOR survey). And then I guess I'd also want it to do the same for the 
