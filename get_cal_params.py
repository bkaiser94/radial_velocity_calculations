...
def get_cal_params(header):
    ...
    if (('goodman' in header['INSTRUME'].lower()) or (header['INSTRUME'] =='') or (header['INSTRUME'].lower()=='ghts_red')):
        ...
        print("No instrument match found but there's still something there:")
