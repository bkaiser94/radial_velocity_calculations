"""
Created 2024-01-25 by Ben Kaiser (UNC-Chapel Hill)

@author: Ben Kaiser

I'm ripping off my make_mordor_stacked_spectra.py file to make a new one for the wide binary survey to make one for the MS+WD wide binary spectra plotting.

This should make stacked spectra of the white dwarf components of the wide binary survey
...
input_file='dimWDMS_allMS_minsepfunc_eDR3_highconf_notrust_justWD_gaiaDR3_d_sbf_Vincent2023bClass_20240125update.csv'


input_table=Table.read(input_file)
current_directory=os.getcwd()
#output_name_base=current_directory.split('/')[-1]
output_name_base='WD_wide_binary'
